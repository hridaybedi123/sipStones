    ...
    return (
        <div>
            ...
            <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
                ...
                <div class="flex flex-col space-y-1 mt-4 -mx-2 h-58 overflow-y-auto">
                    <button
                    ...
                    <div class="ml-2 text-sm font-semibold">Pre-Cal</div>
                    </button>
                    <button
                    class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
                    >
                    ...
                    <div class="ml-2 text-sm font-semibold">Physics</div>
                    <div
                    ...
                    <div class="ml-2 text-sm font-semibold">Chemisty</div>
                    </button>
                    <button
                    class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
                    >
                    ...
                    <div class="ml-2 text-sm font-semibold">English</div>
                    </button>
                    <button
                    class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
                    >
                    ...
                    <div class="ml-2 text-sm font-semibold">Metal Work Technology</div>
                    </button>
                </div>
