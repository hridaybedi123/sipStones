...
function SignUp() {
  return (
    <div className='nana'>
      <h1 className="mt-0 text-left text-5xl font-extrabold text-white py-24 px-36">-Prep for your next step</h1>
       <div className="SignUp">
      <div className="min-h-full flex items-right justify-end py-17 px-6 sm:px-6 lg:px-8">
